...
export const PERSONAS = {
  'pod-lead': { role: 'pod-lead', name: 'Leandro Frasso', title: 'Sr CSA Manager · EMEA TZ Lead', initials: 'LF', color: '#0f6cbd', scope: 'Runs PODs, dispatches, coaches, owns escalations, PIPs & MBRs.' },
  ...
  'business-lt': { role: 'business-lt', name: 'James Miller', title: 'SSD Worldwide Lead', initials: 'JM', color: '#5c2e91', scope: 'Portfolio dashboards, CPE & delivery trends, sentiment, roll-ups.' },
};
