...
export const PERSONAS = {
  ...
  'ww-lead': { role: 'ww-lead', name: 'Jordan Pierce', title: 'Worldwide Lead · SSD', initials: 'JP', color: '#5c2e91', org: 'SSD', scope: 'Full visibility across Compass — global portfolio, CPE & delivery trends, sentiment, MBR roll-ups.' },
  ...
  csa: { role: 'csa', name: 'Noa Feldman', title: 'CSA · Microsoft SSD', initials: 'NF', color: '#107c41', org: 'SSD', scope: 'Sees only their own engagements, dispatch, escalations, enablement and messages. No Quality/CPE, Sentiment, Resource Lifecycle or Reporting.' },
  // CSAM Innovation
