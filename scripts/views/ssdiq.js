...
const CFG = [
  ...
  { key: 'csas', name: 'CSA', description: 'Partner Cloud Solution Architects.', source: 'Operations', icon: 'personAdd', label: (r) => r.name,
    columns: [['id', 'ID'], ['name', 'Name'], ['vendor', 'Vendor'], ['tracks', 'Tracks', (r) => r.tracks.join(', ')], ['utilization', 'Util %'], ['cpe', 'CPE'], ['lifecycle', 'Lifecycle', (r) => statusPill(r.lifecycle)]] },
  ...
  { key: 'engagements', name: 'Engagement', description: 'Dispatched delivery engagements.', source: 'Dispatch', icon: 'send', label: (r) => r.customer,
    columns: [['id', 'ID'], ['customer', 'Customer'], ['track', 'Track'], ['program', 'Program'], ['status', 'Status', (r) => statusPill(r.status)], ['dueDate', 'Due']] },
