...
export const MODULES = [
  ...
  { id: 'quality', path: '/quality', label: 'Quality Checks', icon: 'wrench', roles: [...SSD_LEADERS, ...SSD_MGRS, 'admin'], built: false,
    description: 'Quality Check reviews, Mock Deliveries and Recommended Practices discipline.', ai: 'Auto-scoring against the Recommended Practices checklist.' },
  ...
  { id: 'cpe', path: '/cpe', label: 'CPE Management', icon: 'star', roles: [...SSD_LEADERS, ...SSD_MGRS, 'adoption-lead', 'admin'], built: false,
    description: 'Customer & Partner Experience trends, Recommended Practices scoring and DSAT close-the-loop.', ai: 'Auto-scoring against the Recommended Practices checklist.' },
...
export const NAV_GROUPS = [
  ...
  { title: 'Operations', ids: ['pods', 'lifecycle', 'capacity', 'engagements', 'quality', 'escalations', 'enablement', 'reports-pending'] },
  { title: 'Delivery', ids: ['agentic', 'ip-feedback', 'success-stories', 'cpe', 'sentiment'] },
